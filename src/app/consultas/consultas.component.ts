...
export class ConsultasComponent implements OnInit {
  ...
  ngOnInit() {
    ...
    //NUMERO DE REPORTES 
    this.http.get<any>('https://pacomedina.mx:4201/consulta/numReportes').subscribe(data => {
      // console.log(data);
     ...
     this.http.get<any>('https://pacomedina.mx:4201/consulta/numReportesSol').subscribe(data => {
      // console.log(data);
     ...
     this.http.get<any>('https://pacomedina.mx:4201/consulta/numReportesPen').subscribe(data => {
      // console.log(data);
  ...
  async clickBuscar() {
    ...
    console.log("clicked")
    this.http.post<any>('https://pacomedina.mx:4201/consulta/reporte',busqueda).subscribe(data => {
      // console.log(data);
      this.reportes=data;
  ...
  async clickBuscarTodo() {
   ...
   console.log("clicked")
   this.http.post<any>('https://pacomedina.mx:4201/consulta/reporteG',busqueda).subscribe(data => {
     // console.log(data);
     this.reportes2=data;
